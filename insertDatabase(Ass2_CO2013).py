...
connection_string = 'mssql+pyodbc://ZRMR/Ass2_CO2013?driver=ODBC+Driver+17+for+SQL+Server' #thay thành connection_string của máy mình
...
def staff():
    staff = pd.read_excel('Dataset/staff.xlsx')
...
def administrator():
    administrator = pd.read_excel('Dataset/administrator.xlsx')
...
def week_day():
    week_day = pd.read_excel('Dataset/week_day.xlsx')
...
def province():
    province = pd.read_excel('Dataset/province.xlsx')
...
def district_city():
    district_city = pd.read_excel('Dataset/district_city.xlsx')
...
def ward():
    ward = pd.read_excel('Dataset/ward.xlsx')
...
def address():
    address = pd.read_excel('Dataset/address.xlsx')
...
def time_slot():
    time_slot = pd.read_excel('Dataset/time_slot.xlsx')
...
def certificate_type():
    certificate_type = pd.read_excel('Dataset/certificate_type.xlsx')
...
def class_type():
    class_type = pd.read_excel('Dataset/class_type.xlsx')
...
def subject():
    subject = pd.read_excel('Dataset/subject.xlsx')
...
def teaching_style():
    teaching_style = pd.read_excel('Dataset/teaching_style.xlsx')
...
def student():
    student = pd.read_excel('Dataset/student.xlsx')
...
def educational_institution():
    educational_institution = pd.read_excel('Dataset/educational_institution.xlsx')
...
def consultation_req():
    consultation_req = pd.read_excel('Dataset/consultation_req.xlsx')
...
def wants_subject():
    wants_subject = pd.read_excel('Dataset/wants_subject.xlsx')
...
def wants_type():
    wants_type = pd.read_excel('Dataset/wants_type.xlsx')
...
def wants_style():
    wants_style = pd.read_excel('Dataset/wants_style.xlsx')
...
def tutor():
    tutor = pd.read_excel('Dataset/tutor.xlsx')
...
def voucher():
    voucher = pd.read_excel('Dataset/voucher.xlsx')
...
def tutor_application():
    tutor_application = pd.read_excel('Dataset/tutor_application.xlsx')
...
def can_teach_at():
    can_teach_at = pd.read_excel('Dataset/can_teach_at.xlsx')
...
def can_teach_style():
    can_teach_style = pd.read_excel('Dataset/can_teach_style.xlsx')
...
def can_teach_type():
    can_teach_type = pd.read_excel('Dataset/can_teach_type.xlsx') 
...
def certificate():
    certificate = pd.read_excel('Dataset/certificate.xlsx')
...
def bill():
    bill = pd.read_excel('Dataset/bill.xlsx') 
...
def can_teach():
    can_teach = pd.read_excel('Dataset/can_teach.xlsx')
...
def degree():
    degree = pd.read_excel('Dataset/degree.xlsx')  # Assuming your file is named 'degree.xlsx'
...
def has():
    has = pd.read_excel('Dataset/has.xlsx')
...
def qualification():
    qualification = pd.read_excel('Dataset/qualification.xlsx')
...
def class_data():
    class_data = pd.read_excel('Dataset/class.xlsx')  
...
def belongs_to():
    belongs_to = pd.read_excel('Dataset/belongs_to.xlsx')
...
def is_held_on():
    is_held_on = pd.read_excel('Dataset/is_held_on.xlsx')
...
def tutor_review():
    tutor_review = pd.read_excel('Dataset/tutor_review.xlsx')  
...
def has_class_type():
    has_class_type = pd.read_excel('Dataset/has_class_type.xlsx')
...
def has_subject():
    has_subject = pd.read_excel('Dataset/has_subject.xlsx')
...
def teaching_application():
    teaching_application = pd.read_excel('Dataset/teaching_application.xlsx')
...
def s_wants_subject():
    s_wants_subject = pd.read_excel('Dataset/s_wants_subject.xlsx')
...
def s_wants_type():
    s_wants_type = pd.read_excel('Dataset/s_wants_type.xlsx')
