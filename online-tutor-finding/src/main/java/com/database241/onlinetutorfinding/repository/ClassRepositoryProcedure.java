...
@Repository
public class ClassRepositoryProcedure
{
    @PersistenceContext
    private EntityManager entityManager;


    public Long insertClass(Long classDeposit, String classStatus,
                            Long commissionFee, String requirements,
                            LocalDateTime dateStart, Long salary,
                            Long addrId, Long studentId,
                            Long tsId, Long tutorId)
    {
